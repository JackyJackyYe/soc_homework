...
HD_PWD='E:/fpga/soc_homework/soc_homework.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_CLA_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_CLA_top.tcl
